...
software_gz_path=`get_value ${pname_software_gz_path}  ${config_file} `
if [[ ! ${software_gz_path} =~ ^/ ]] ;then
software_gz_path="${base_dir}/${software_gz_path}"
fi
